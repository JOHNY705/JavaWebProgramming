...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/ComputerShop/static/styles/adminUserOrders.css" type="text/css">
        ...
        <script src="/ComputerShop/static/scripts/adminUserOrders.js"></script>
    </head>
    <body>
        <jsp:include page="../components/navbar.jsp" />
        <div id="contentContainer" class="container">
            <h1>Narudžbe korisnika</h1>
            <table id="ordersTable" class="table">
                <thead class="ordersTableHead">
                    <tr class="ordersTableHeadRow">

...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/ComputerShop/static/styles/adminUserLogs.css" type="text/css">
        ...
        <script src="/ComputerShop/static/scripts/adminUserLogs.js"></script>
    </head>
    <body>
